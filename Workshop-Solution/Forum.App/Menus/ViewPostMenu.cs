namespace Forum.App.Menus
{
	...
	public class ViewPostMenu : Menu, IIdHoldingMenu
	{
		...
		public ViewPostMenu(ILabelFactory labelFactory, ISession session, ICommandFactory commandFactory, IPostService postService, IForumViewEngine viewEngine, int postId)
        {
